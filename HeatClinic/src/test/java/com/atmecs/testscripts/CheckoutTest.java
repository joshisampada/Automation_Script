...
{
	CommanUtils list=new CommanUtils();
	WebDriver driver;
	...
	public void checkout() throws InterruptedException 
	{
		...
		String afterUpdateText1 = driver.findElement(By.id("subtotal")).getText();

		Assert.assertTrue(beforeUpdateText.equals(afterUpdateText1));
		...
		String bforUpdateText = driver.findElement(By.id("subtotal")).getText();
		...
		//verify update
		Assert.assertTrue(bforUpdateText.equals(afterUpdateText));
		System.out.println("update success");
